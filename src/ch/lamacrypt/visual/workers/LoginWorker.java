...
import ch.lamacrypt.internal.network.Authentication;
...
/**
 * SwingWorker for login related operations
 *
 * @author LamaGuy
 */
        ...
        try {
            if (get()) {
                ...
                if (Settings.isNew()) {
                    ...
                    String msg1 = "It appears it is your first time using the LamaCrypt client. Before continuing, "
                            ...
                            + "minimum length of 20 characters, with an upper bound of 64."
                    ...
                    while (!done) {
                        ...
                        } else if (passField.getPassword().length < 20 || passField.getPassword().length > 64) {
