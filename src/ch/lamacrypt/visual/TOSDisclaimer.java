...
/**
 * Prompts the user to accept or decline the Terms of Use
 *
 * @author LamaGuy
 */
public class TOSDisclaimer extends javax.swing.JFrame {
    ...
    public TOSDisclaimer() {
        ...
        String TOS
                = "LamaCrypt Terms of Use\n"
                + "v1.0\n\n"
                + "By using this software, you acknowledge that you have read and accepted the LamaCrypt"
                + " Terms of Service (https://www.lamacrypt.ch/tos.php).\n\n"
                + "If you do not agree with the LamaCrypt Terms of Service, you may not use this software "
                + "and must close it and delete it immediately.";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("By using this software, you accept the following Terms of Use:");
